...
public:
    ...
    // recurse depth
    //
    enum { RECURSE_INFINITE = -1 };
    void    SetRecurseDepth( int depth )    { mRecurseDepth = depth; }
    int     GetRecurseDepth() const         { return mRecurseDepth; }
...
//////////////////////////
inline cFCOSpecStopPointIter::cFCOSpecStopPointIter(cFCOSpecStopPointSet& set) :

...
private:\
    TYPE m##NAME;\
public:\
void            Set##NAME (TYPE::ValueType value)   { mValidProps.AddItem(INDEX);               m##NAME.SetValue(value); }\
TYPE::ValueType Get##NAME () const                  { ASSERT(mValidProps.ContainsItem(INDEX));  return m##NAME.GetValue(); }\
void            SetUndefined##NAME ()               { mValidProps.AddItem(INDEX);               mUndefinedProps.AddItem(INDEX); } 
...
void        SetValid##NAME (bool valid)             { if (valid) mValidProps.AddItem(INDEX); else mValidProps.RemoveItem(INDEX); }\
void        SetDefined##NAME (bool defined)         { SetValid##NAME(true); if (!defined) mUndefinedProps.AddItem(INDEX); else mUndefinedProps.RemoveItem(INDEX); }
///////////////////////////////////////////////////////////////////////////////

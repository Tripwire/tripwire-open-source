...
void cBlockRecordArray::DeleteItem(int index) //throw (eArchive)
{
    ...
    {   
        ...
        //
        int sizeToShift = indexArray.maRecordIndex[GetNumItems()-1].GetOffset() - indexArray.maRecordIndex[index].GetOffset();
...
// IsClassValid
///////////////////////////////////////////////////////////////////////////////
#define BRA_ASSERT(x) if(x) ; else { ASSERT(false); return false; }
...
void cBlockRecordArray::TraceContents(int dl) const
{
    ...
    {
        d.Trace( dl, "(%d)\tOffset %d\tMain Idx %d\n",  i, indexArray.maRecordIndex[i].GetOffset(), indexArray.maRecordIndex[i].GetMainIndex() );
    }
